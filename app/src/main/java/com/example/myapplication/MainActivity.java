...
public class MainActivity extends AppCompatActivity
    ...
    private static final int UPDATE_INTERVAL_MS = 1000; //1분단위
    ...
    Button btnForLog;
    TextView tvUser, tvPass, toastText;
    View dialog1View, toastView, joinView;
    EditText loginId, passWordIn;
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        try {
            ...
            Toast.makeText(this, "지오코더 서비스 사용불가", Toast.LENGTH_LONG).show();// 네트워크에러
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        subMenu.add(0, 3, 0, "login");
        subMenu.add(0, 4, 0, "회원 가입");
        return true;
    }
    ...
    public void setDialog1View() {
        ...
        dlg1.setView(dialog1View);
        dlg1.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                loginId = (EditText) dialog1View.findViewById(R.id.loginId);
                passWordIn = (EditText) dialog1View.findViewById(R.id.passwordIn);

                String user = loginId.getText().toString().trim();
                ...
                if (user.equals("") || pass.equals("")){
                    ...
                    if (checkUserPass == true){
                        Toast.makeText(getApplicationContext(), user+"님 로그인이 되었습니다.", Toast.LENGTH_LONG).show();
                    }else {
        ...
        dlg1.setNegativeButton("취소", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                toastView = (View) View.inflate(MainActivity.this, R.layout.successinput, null);
                toastText = (TextView) toastView.findViewById(R.id.successTst);
    ...
    public void setJoinDialog(){
        Toast.makeText(MainActivity.this, "회원가입페이지로 이동",Toast.LENGTH_SHORT).show();
